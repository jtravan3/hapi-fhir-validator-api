...
public class ValidationEndpointV2_1 {
    ...
    @Autowired
    public ValidationEndpointV2_1(@NonNull ValidationService validationService) {
    ...
    public ValidationResponse validate(@ApiParam(name = "fhirJson", value = "FHIR JSON object to be validated", required = true)
        ...
        return validationService.validate(fhirJson, FhirVersionEnum.DSTU2_1, isCodeSystemsIgnored);
    }
