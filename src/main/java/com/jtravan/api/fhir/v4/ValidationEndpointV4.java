...
public class ValidationEndpointV4 {
    ...
    @Autowired
    public ValidationEndpointV4(@NonNull ValidationService validationService) {
    ...
    public ValidationResponse validate(@ApiParam(name = "fhirJson", value = "FHIR JSON object to be validated", required = true)
        ...
        return validationService.validate(fhirJson, FhirVersionEnum.R4, isCodeSystemsIgnored);
    }
